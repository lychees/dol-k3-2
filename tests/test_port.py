...
with sync_playwright() as p:
    ...
    page.screenshot(path="tests/screenshots/port_lisbon.png")
    ...
    page.screenshot(path="tests/screenshots/port_walk.png")
    ...
    page.screenshot(path="tests/screenshots/port_building.png")
    ...
    page.screenshot(path="tests/screenshots/village_discovery.png")
    page.keyboard.press("Escape")
    page.wait_for_timeout(300)
    ...
    page.wait_for_timeout(500)
    page.screenshot(path="tests/screenshots/port_night.png")
