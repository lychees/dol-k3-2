...
with sync_playwright() as p:
    ...
    page.screenshot(path="tests/screenshots/mate_card.png")
    ...
    page.screenshot(path="tests/screenshots/outfit_panel.png")
    ...
    page.screenshot(path="tests/screenshots/battle_armor.png")
